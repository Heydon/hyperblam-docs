...
![A chart plotting amplitude (y) against frequency (x). An amplifier is trapped behind a drop in frequency at 7K. Its output can’t break through this wall.]({{site.basedircdn}}/static/images/illustrations/filters1.svg)
...
![A foot tilted backwards on a pedal with a diagram of a frequency band appearing on the left. Underneath a foot is tilted forward on a pedal and the band has shifted to the right.]({{site.basedircdn}}/static/images/illustrations/filters3.svg)
...
![A guitar amplifier with two microphones positioned with one closer to the amplifier than the other.]({{site.basedircdn}}/static/images/illustrations/filters2.svg)
...
![Two copies of the same waveform become exactly out of alignment. One’s peak aligns with the other’s trough.]({{site.basedircdn}}/static/images/illustrations/filters4.svg)
