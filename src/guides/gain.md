...
The [“Light Lo-Fi Listen With LFOs”]({{site.basedir}}/examples/07-a-light-lo-fi-listen-with-lfos/) example uses an `<echo-blam>` for the plucked, guitar-like instrument.
